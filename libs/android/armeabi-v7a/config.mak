...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --enable-cross-compile --cross-prefix=arm-linux-androideabi- --sysroot=/home/linux1/workspace/tools/toolchain/arm/sysroot/ --enable-static --disable-shared --enable-gpl --enable-version3 --disable-programs --disable-ffplay --disable-ffprobe --disable-ffserver --disable-ffmpeg --disable-doc --disable-txtpages --disable-htmlpages --disable-manpages --disable-podpages --enable-network --enable-avdevice --enable-avfilter --enable-avresample --enable-swresample --enable-decoders --enable-encoders --enable-hwaccels --enable-muxers --enable-demuxers --enable-parsers --enable-filters --enable-protocols --disable-bsfs --disable-indevs --disable-outdevs --prefix=/home/linux1/workspace/ffmpeg/ffmpeg_2_7_2/build/arm --extra-cflags='-O3 -Wall -mthumb -pipe -fpic -fasm 					-finline-limit=300 -ffast-math 							-fstrict-aliasing -Werror=strict-aliasing 				-fmodulo-sched -fmodulo-sched-allow-regmoves			-Wno-psabi -Wa,--noexecstack 							-DANDROID -DNDEBUG -march=armv7-a -mfpu=neon -mfloat-abi=softfp -mvectorize-with-neon-quad' --extra-ldflags='-Wl,--fix-cortex-a8'
prefix=/home/linux1/workspace/ffmpeg/ffmpeg_2_7_2/build/arm
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/home/linux1/workspace/tools/toolchain/arm/sysroot/ -isysroot /home/linux1/workspace/tools/toolchain/arm/sysroot/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -O3 -Wall -mthumb -pipe -fpic -fasm -finline-limit=300 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -fmodulo-sched -fmodulo-sched-allow-regmoves -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -march=armv7-a -mfpu=neon -mfloat-abi=softfp -mvectorize-with-neon-quad -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -mthumb -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -O3 -Wall -mthumb -pipe -fpic -fasm -finline-limit=300 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -fmodulo-sched -fmodulo-sched-allow-regmoves -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -march=armv7-a -mfpu=neon -mfloat-abi=softfp -mvectorize-with-neon-quad -march=armv7-a -fPIC -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS= -Wl,--fix-cortex-a8  --sysroot=/home/linux1/workspace/tools/toolchain/arm/sysroot/ -isysroot /home/linux1/workspace/tools/toolchain/arm/sysroot/ -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
