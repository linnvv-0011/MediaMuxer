...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-static --disable-shared --enable-gpl --enable-version3 --enable-w32threads --disable-programs --disable-ffplay --disable-ffprobe --disable-ffserver --enable-ffmpeg --disable-doc --disable-txtpages --disable-htmlpages --disable-manpages --disable-podpages --enable-network --enable-avdevice --enable-avfilter --enable-avresample --enable-swresample --enable-decoders --enable-encoders --enable-hwaccels --enable-muxers --enable-demuxers --enable-parsers --enable-filters --enable-protocols --prefix=/cygdrive/e/workspace/test/build/x86
prefix=/cygdrive/e/workspace/test/build/x86
...
EXTRALIBS=-lavicap32 -lgdi32 -liconv -lm -lz -pthread -lpsapi -ladvapi32 -lshell32 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
